...
extern const unsigned DV_FVF_VERTEXCUV;
...
struct TVertexCUV
{
  ...
  void Set(float _x, float _y, float _z, float _nx, float _ny, float _nz, dword _c, float _u, float _v) { x = _x; y = _y; z = _z; nx = _nx; ny = _ny; nz = _nz; c = _c; u = _u; v = _v; }
};
